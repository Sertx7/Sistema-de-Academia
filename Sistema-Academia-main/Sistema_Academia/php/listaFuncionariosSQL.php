    ...
    while($row = $result->fetch_assoc()) {
        echo '
                <div class="usuario">
                    ...
                    <i class="assinatura">'. $row["Cargo"] .'</i>
                    </div>
                    ...
                    <div class="deletar">
                        <svg style="cursor: pointer;" class="mudarFuncionario" data-id="'. $row["ID_funcionarios_pk"] .'" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-trash-fill"
                        viewBox="0 0 16 16">
                        <path
